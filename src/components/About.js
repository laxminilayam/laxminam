                        ...
                        <div className="grid md:grid-cols-2 gap-6 md:gap-16 items-center">
                            ...
                            >
                                ...
                                <motion.p variants={fadeIn} className=" text-sm md:text-lg text-gray-700 leading-relaxed">
                                    RECOMMEND TO ADD - Lakshmi Nilayam is a place where your dream home becomes a reality. This Gated community apartment in Guntur is designed to offer a perfect mix of comfort, style and convenience.<br /><br />
